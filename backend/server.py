...
async def submit_contact_inquiry(input: ContactInquiryCreate):
    """
    Submit a contact inquiry from the Brigade Belvedere website
    """
    ...
    logger.info(f"New contact inquiry from {contact_obj.name} ({contact_obj.email})")
...
async def get_contact_inquiries():
    """
    Retrieve all contact inquiries (for admin purposes)
    """
